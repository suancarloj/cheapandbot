...
bot.dialog('/cheap', [function (session) {
    ...
    var msg = new builder.Message(session).attachmentLayout(builder.AttachmentLayout.carousel).attachments([new builder.CardImage(session).url("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Seattlenighttimequeenanne.jpg/320px-Seattlenighttimequeenanne.jpg").postBack(session, "select:102", "Select")]);
    // Ask the user to select an item from a carousel.
