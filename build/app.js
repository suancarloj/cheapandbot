...
var uploadSpeech = function uploadSpeech(fileUrl, language, API_USER_ID, token, cb) {
...
bot.dialog('/speech', [function (session, result, next) {
    ...
    uploadSpeech(result.response.contentUrl, 'en-US', 8967, 'NDhjZjRhY2MtOTRmMi00MWY2LWExNGItOTlmMGE4MDQ3YjIw ', function (err, res) {
        if (err) {
